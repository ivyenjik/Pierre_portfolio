...
export default function Project() {
	return (
		<div className="about-me-container bg-light" id="projects">
            ...
            <div className='row offset-lg-2 pt-5 pb-5'>
                ...
                <div className="col-lg-3 col-sm-5">
			        <img className='img-fluid project-img' src={require ('../../assets/home/school.jpeg')} 
                         ...
                         add student grades, modify student grades, manage students by class, view grades for subjects    .</p>
                    <a href='https://github.com/pierre265/school_manager'><button className='btn button mb-3'> View project</button></a>
		        </div>
                <div className="col-lg-3 col-sm-5">
			        <img className='img-fluid project-img' src={require ('../../assets/home/com.jpeg')} 
                         alt="No Internet connection"/><p className='project-description pt-3'>To develop an 
                         intelligent communication designed to optimise and improve post-operative interactions between patients and carers.</p>
                    <a href='https://github.com/pierre265/caregiver'><button className='btn button mb-3'> View project</button></a>
		        </div>
            </div>
